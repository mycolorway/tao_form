...
import SegmentBase from '../segments/base'
import moment from 'moment'
import _ from 'lodash'
import $ from 'jquery'

class MomentPickerSegmentListElementBase extends Component
  ...
  _findSegment: (segmentName) ->
    if segmentName instanceof SegmentBase
      return segmentName
...
export default MomentPickerSegmentListElementBase
